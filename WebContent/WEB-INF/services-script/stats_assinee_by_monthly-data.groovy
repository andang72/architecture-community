...
public class StatsByAssineeAndMonthly extends architecture.community.web.spring.view.AbstractScriptDataView  {
	...
	Object handle(Model model, HttpServletRequest request, HttpServletResponse response) throws Exception{ 
		...
		dataSourceRequest.setStatement("COMMUNITY_CUSTOM.SELECT_ISSUE_STATS_BY_ASSIGNEE_MONTHLY");	
