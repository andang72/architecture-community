...
<head>
    ...
    <link rel="stylesheet" href="<@spring.url "/assets/vendor/pdf.js/web/viewer.css"/>">
    <link rel="resource" type="application/l10n" href="<@spring.url "/assets/vendor/pdf.js/web/locale/locale.properties"/>">
	<script src="<@spring.url "/assets/vendor/pdf.js/build/pdf.js"/>"></script> 
	<style> 
		body {
		  font-weight: 100;
		  font-size: 1rem;
		  font-family: "나눔 고딕", "Nanum Gothic, Helvetica Neue",Helvetica,Arial,sans-serif;; 
		  line-height: 1.6;
		  color: #555;
...
<body tabindex="1" class="loadingInProgress">
	...
	function configure(PDFJS) {
	  PDFJS.imageResourcesPath = '/assets/vendor/pdf.js/web/images/';
	  PDFJS.workerSrc = '/assets/vendor/pdf.js/build/pdf.worker.js';
	  PDFJS.cMapUrl = '/assets/vendor/pdf.js/web/cmaps/';
