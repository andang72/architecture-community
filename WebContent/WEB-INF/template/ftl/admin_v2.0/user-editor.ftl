...
<head>	
	...
	require.config({
		...
		paths : {
			...
			"bootstrap" 	   				: "/js/bootstrap/4.0.0/bootstrap.bundle", 
	...
	require([ "jquery", "bootstrap", "jquery.cookie",  "kendo.web.min", "community.ui.core", "community.data", "community.ui.professional", "community.ui.admin", "summernote.min", "summernote-ko-KR", "dropzone" ], function($, kendo ) { 
