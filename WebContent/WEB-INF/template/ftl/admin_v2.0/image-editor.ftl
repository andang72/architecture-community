...
<head>	
	...
	require.config({
		shim : {
	        ...
	        "kendo.messages.ko-KR"	 		: { "deps" :['jquery', 'kendo.web.min'] },
	...
	require([ "jquery", "jquery.cookie", "kendo.web.min", "community.ui.core", "community.data", "community.ui.professional", "community.ui.admin", "dropzone"], function($, kendo ) { 
