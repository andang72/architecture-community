...
<head>	
	...
	function createMenusListView(){
		...
		community.ui.pager( $("#menus-listview-pager"), {
			...
			<div class="g-pa-20">
				...
				<div id="features" class="container-fluid">
					...
					<div class="row">
						...
						<table class="table u-table--v3 g-color-black">
							<thead>
								<tr class="g-bg-gray-light-v8">
									<th class="g-valign-middle g-width-100 g-px-30 sorting" data-kind="menu" data-action="sort" data-dir="asc" data-field="MENU_ID" >
										<div class="media">
						...
						<div id="menus-listview-pager" class="g-brd-top-none" style="width:100%;"></div>
            				<!-- menu listview end -->
					</div>
				</div>
				<!-- End Content Body -->
