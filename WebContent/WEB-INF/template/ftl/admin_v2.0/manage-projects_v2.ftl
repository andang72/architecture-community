...
<head>	
	...
	require([ "jquery","jquery.cookie",  "bootstrap", "community.data", "community.ui.admin", "kendo.messages.min" ], function($, kendo ) { 
		...
		observable = new community.ui.observable({ 
			...
			projectStateDataSource : community.ui.datasource( '<@spring.url "/data/api/mgmt/v1/codeset/PROJECT/list.json" />' , {} )
		});
		...
		observable.projectStateDataSource.read();
		...
		renderTo.on("click", "button[data-object-type=project], .sorting[data-kind=project], a[data-object-type=project]", function(e){			
			...
			if( actionType == 'sort'){
				...
				community.ui.send("<@spring.url "/secure/display/ftl/admin_v2.0/project-editor_v2" />", { projectId: $this.data("object-id") });
				return false;
			}
	...
	function getProjectStateName(code){ 
		var name = ""; 
		if( code == null )
			return ""; 
			
			var data = observable.projectStateDataSource.data();
	...
	function createProjectGrid(){
		...
		var grid = community.ui.grid( renderTo , {
			dataSource: community.ui.datasource_v2({
				transport:{
					read:{
						...
						url : '<@spring.url "/data/api/mgmt/v1/projects/list.json"/>',
						type : 'POST',
						dataType : 'json'
					},
			...
			columns: [
				{ field: "PROJECT_ID", title: "ID", filterable: false, sortable: true , width : 100 , template:'#= projectId #', attributes:{ class:"text-center" }}, 
				{ field: "CONTRACTOR", title: "계약자", filterable: false, sortable: true , width : 120 ,template:'#= getContractorName( contractor ) #' }, 
				{ field: "NAME", title: "프로젝트", filterable: false, sortable: true, template: $('#name-column-template').html()  },  
				{ field: "CONTRACT_STATE", title:"상태", filterable: false, sortable: true, template:'#: getProjectStateName(contractState) #' , attributes:{ class:"text-center" } , width:100 },  
				{ field: "MAINTENANCE_COST", title: "비용(월)", filterable: false, sortable: true , width : 120, template : '#= community.data.getFormattedNumber(maintenanceCost) #', attributes:{ class:"text-right" } },  
				{ title: "기간", filterable: false, sortable: false , width : 200, template : '#: community.data.getFormattedDate( startDate , "yyyy.MM.dd")  # ~ #: community.data.getFormattedDate( endDate, "yyyy.MM.dd" )  #' },  
...
<body class="">
			...
			<div class="g-pa-20">
				...
				<div id="features" class="container-fluid">
					<div class="row text-center text-uppercase g-bord-radias g-brd-gray-dark-v7 g-brd-top-0 g-brd-left-0 g-brd-right-0 g-brd-style-solid g-brd-3">
						...
						<a href="javascript:void();" class="btn btn-xl u-btn-3d u-btn-primary g-width-180--md g-mb-10 g-font-size-default g-ml-10" data-action="create" data-object-type="project"  data-object-id="0" >새로운 프로젝트 만들기</a>
						</div>
					</div>				
					<div class="row"> 
						<div id="project-grid" class="g-brd-gray-dark-v7 g-brd-top-0 g-brd-left-0 g-brd-right-0 g-brd-style-solid g-brd-3"></div>  
					</div>  	
				</div>
				<!-- End Content Body -->
			</div>
	...
	<p class="g-font-weight-300 g-color-gray-dark-v6 g-mt-5 g-ml-10 g-mb-0" > 
		# if ( contractState == '002') { # <span class="u-label u-label-default g-rounded-20 g-mr-10 g-mb-0">무상</span> # } else if (contractState == '001') { # <span class="u-label u-label-primary g-rounded-20 g-mr-10 g-mb-0">유상</span> # } #
