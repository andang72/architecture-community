...
<head>
  ...
  <!-- Bootstrap Theme CSS Unify -->
  <link href="<@spring.url "/css/bootstrap.theme/inspinia/style.css"/>" rel="stylesheet" type="text/css" />
  
  <!-- CSS Community -->
  <link href="<@spring.url "/css/community.ui/community.ui.globals.css"/>" rel="stylesheet">
  ...
  <main class="g-height-100x g-min-height-100vh g-flex-centered g-pa-15">
    <div class="text-center g-flex-centered-item g-position-rel">
      ...
      <div class="g-absolute-centered">
        <h1 class="g-font-weight-200 g-mb-20">Unauthorized</h1>
