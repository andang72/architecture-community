	...
	--  FORUM	
	-- =================================================	
		CREATE TABLE MUSI_FORUM_THREAD (
			THREAD_ID			INTEGER NOT NULL,
		 	...
		 	CONSTRAINT MUSI_FORUM_THREAD_PK PRIMARY KEY (THREAD_ID)
		);

		COMMENT ON TABLE "MUSI_FORUM_THREAD"  IS '게시물 스레드(토픽) 테이블';
		COMMENT ON COLUMN "MUSI_FORUM_THREAD"."THREAD_ID" IS '게시물 스레드 ID'; 
		COMMENT ON COLUMN "MUSI_FORUM_THREAD"."OBJECT_TYPE" IS '게시물이 속하는 객체 유형'; 	
		COMMENT ON COLUMN "MUSI_FORUM_THREAD"."OBJECT_ID" IS '게시물이 속하는 객체 ID'; 	
		COMMENT ON COLUMN "MUSI_FORUM_THREAD"."ROOT_MESSAGE_ID" IS '최초 게시물 ID'; 
		COMMENT ON COLUMN "MUSI_FORUM_THREAD"."CREATION_DATE" IS '생성일자'; 
		COMMENT ON COLUMN "MUSI_FORUM_THREAD"."MODIFIED_DATE" IS '수정일자'; 
		
		
		CREATE TABLE MUSI_FORUM_MESSAGE (
		    ...
		    CREATION_DATE		TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,
		    MODIFIED_DATE		TIMESTAMP DEFAULT SYSTIMESTAMP NOT NULL,
		 	CONSTRAINT MUSI_FORUM_MESSAGE_PK PRIMARY KEY (MESSAGE_ID)
		);

		COMMENT ON TABLE "MUSI_FORUM_MESSAGE"  IS '게시물 테이블';
		COMMENT ON COLUMN "MUSI_FORUM_MESSAGE"."MESSAGE_ID" IS '게시물 ID'; 
		COMMENT ON COLUMN "MUSI_FORUM_MESSAGE"."PARENT_MESSAGE_ID" IS '부모 게시물 ID'; 
		COMMENT ON COLUMN "MUSI_FORUM_MESSAGE"."THREAD_ID" IS '게시물 스레드 ID'; 
		COMMENT ON COLUMN "MUSI_FORUM_MESSAGE"."OBJECT_TYPE" IS '게시물이 속하는 객체 유형'; 	
		COMMENT ON COLUMN "MUSI_FORUM_MESSAGE"."OBJECT_ID" IS '게시물이 속하는 객체 ID'; 	
		COMMENT ON COLUMN "MUSI_FORUM_MESSAGE"."USER_ID" IS '게시자 ID'; 	
		COMMENT ON COLUMN "MUSI_FORUM_MESSAGE"."SUBJECT" IS '제목'; 	
		COMMENT ON COLUMN "MUSI_FORUM_MESSAGE"."BODY" IS '내용'; 	
		COMMENT ON COLUMN "MUSI_FORUM_MESSAGE"."CREATION_DATE" IS '생성일자'; 
		COMMENT ON COLUMN "MUSI_FORUM_MESSAGE"."MODIFIED_DATE" IS '수정일자'; 
		
		
		CREATE INDEX MUSI_FORUM_MESSAGE_IDX_01 ON MUSI_FORUM_MESSAGE (THREAD_ID);
		CREATE INDEX MUSI_FORUM_MESSAGE_IDX_02 ON MUSI_FORUM_MESSAGE (USER_ID);
		CREATE INDEX MUSI_FORUM_MESSAGE_IDX_03 ON MUSI_FORUM_MESSAGE (PARENT_MESSAGE_ID);
		CREATE INDEX MUSI_FORUM_MESSAGE_IDX_04 ON MUSI_FORUM_MESSAGE (OBJECT_TYPE, OBJECT_ID, MODIFIED_DATE);
