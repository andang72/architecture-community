  ...
  CREATE TABLE MUSI_PAGE_VERSION
   (	
	...
	CREATE TABLE MUSI_ISSUE (	
		...
		CREATION_DATE				DATE DEFAULT  SYSDATE NOT NULL,
		MODIFIED_DATE				DATE DEFAULT  SYSDATE NOT NULL,			
		CONSTRAINT MUSI_ISSUE_PK PRIMARY KEY (ISSUE_ID)
	); 
	
	CREATE INDEX MUSI_ISSUE_IDX1 ON MUSI_ISSUE (OBJECT_TYPE, OBJECT_ID) ;
	CREATE INDEX MUSI_ISSUE_IDX2 ON MUSI_ISSUE (OBJECT_TYPE, OBJECT_ID, ISSUE_TYPE) ;
