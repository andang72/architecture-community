...
package architecture.community.attachment.dao.impl;
...
public class JdbcAttachmentDao extends ExtendedJdbcDaoSupport implements AttachmentDao {
	...
	public Attachment getByAttachmentId(long attachmentId) {
		return getExtendedJdbcTemplate().queryForObject(getBoundSql("COMMUNITY_WEB.SELECT_ATTACHMENT_BY_ID").getSql(), attachmentMapper, new SqlParameterValue (Types.NUMERIC, attachmentId ));		
	}
